...
export const exchangeCodeForToken = async (
  code: string,
): Promise<{ access_token: string; token_type: string; expires_in: number; refresh_token: string; account_id: string }> => {
 ...
 */
export const fetchHarvestAccounts = async (
  accessToken: string
): Promise<HarvestAccountsResponse> => {
 ...
 */
export const fetchHarvestUser = async (
  accessToken: string,
